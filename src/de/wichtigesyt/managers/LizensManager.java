...
public class LizensManager {
    ...
    public LizensManager(String licenseKey, String validationServer, Main plugin) {
        this.licenseKey = licenseKey;
        this.plugin = (Plugin) plugin;
        this.validationServer = validationServer;
    }

    public LizensManager setSecurityKey(String securityKey) {
        this.securityKey = securityKey;
        return this;
    }

    public LizensManager setConsoleLog(LogType logType) {
        this.logType = logType;
        return this;
    }

    public LizensManager debug() {
        debug = true;
        return this;
    }
    ...
    public boolean register() {
        ...
        if (vt == ValidationType.VALID) {
            ...
            Bukkit.getScheduler().cancelTasks((org.bukkit.plugin.Plugin) plugin);
            Bukkit.getPluginManager().disablePlugin((org.bukkit.plugin.Plugin) plugin);
            return false;
        }
    }
